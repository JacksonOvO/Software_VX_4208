...
#define MBS_SERIAL_API_VERSION                  ( 2 ) /*使用APV2 zhangyong*/
#endif
...
#define MBS_NCUSTOM_FUNCTION_HANDLERS               ( 0 )/*用户自己定义的功能码*/
#endif
...
/* BEGIN: Added by lwe004, 2017/9/18   PN:使能读写文件记录功能码0x14 0x15*/
...
/* ----------------------- Function prototypes ------------------------------*/
/* BEGIN: Added by lwe004, 2017/9/17   PN:日志打印 */
...
/* BEGIN: Added by lwe004, 2017/9/18   PN:0x14功能码 子请求数量,大于等于35*/
...
/* BEGIN: Added by lwe004, 2017/10/17   PN:0x15功能码 子请求数量 ，与子请求数据长度有关*/
